export const translations = {
  ar: {
    ...
    // Services Section
    servicesTitle: 'خدماتنا التقنية المتطورة',
    servicesDescription: 'نقدم مجموعة شاملة من الحلول التقنية المصممة خصيصاً لتلبية احتياجات المشاريع الإنشائية والمعمارية',
    ...
    cloudSolutionsDesc: 'بنية تحتية سحابية آمنة وقابلة للتوسع',
    cyberSecurity: 'الأمن السيبراني',
    cyberSecurityDesc: 'حماية شاملة للأنظمة والبيانات',
    dataAnalytics: 'تحليل البيانات',
    dataAnalyticsDesc: 'استخراج الرؤى من البيانات الضخمة',
    systemIntegration: 'تكامل الأنظمة', 
    systemIntegrationDesc: 'ربط وتكامل الأنظمة المختلفة',
    
    // Team Section
    teamTitle: 'فريق الخبراء',
    teamDescription: 'مجموعة من المطورين والمهندسين المتخصصين في أحدث التقنيات',
    ...
    exploreAllProjects: 'استكشف جميع مشاريعنا',
    months: 'أشهر',
  ...
  en: {
    ...
    // Services Section
    servicesTitle: 'Advanced Technical Services',
    ...
    cloudSolutionsDesc: 'Secure and scalable cloud infrastructure',
    cyberSecurity: 'Cybersecurity',
    cyberSecurityDesc: 'Comprehensive system and data protection',
    ...
    teamDescription: 'A group of developers and engineers specialized in the latest technologies',
